...
public class UserController {
	...
	// http://localhost:8585/users/findUserByEmailPass/{uEmail}/{uPassword}
	@GetMapping(value = "findUserByEmailPass/{uEmail}/{uPassword}")
	public List<User> findUserByEmailPass(@PathVariable("uEmail") String uEmail,@PathVariable("uPassword") String uPassword) {
		return userService.findUserByEmailPass(uEmail,uPassword);
	}
